...
tf.app.flags.DEFINE_string('label_map_path', '/samjith/project/platform_grating/platform_dataset/kitti_label_map.pbtxt',
                           'Path to label map proto.')
tf.app.flags.DEFINE_integer('validation_set_size', '14', 'Number of images to'
